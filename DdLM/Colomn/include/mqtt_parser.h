...
//                                        GLOBAL VARIABLES
//------------------------------------------------------------------------------------------------------
uint8_t mac[6] = {0x42,0xC8,0x1A,0x0A,0xFD,0x04};
...
void mqttParser(uint16_t command)
{
    switch(command)
    {
		...
		//loads
		case SMOKE_POWER_ON:
			loadControl(SMOKE_POWER, ON);
			break;

		case SMOKE_POWER_OFF:
			loadControl(SMOKE_POWER, OFF);
			break;		

		case SMOKE_BTN_ON:
			loadControl(SMOKE_BTN, ON);
			break;
		...
		case SYMBOL_WEIGHT_ON:
			loadControl(SYMBOL_WEIGHT, ON);
			break;

		case SYMBOL_WEIGHT_OFF:
			loadControl(SYMBOL_WEIGHT, OFF);
			break;	

		case SYMBOL_SMELLS_ON:
			loadControl(SYMBOL_SMELLS, ON);
			break;

		case SYMBOL_SMELLS_OFF:
			loadControl(SYMBOL_SMELLS, OFF);
			break;	

		case SYMBOL_TOUCH_ON:
			loadControl(SYMBOL_TOUCH, ON);
			break;

		case SYMBOL_TOUCH_OFF:
			loadControl(SYMBOL_TOUCH, OFF);
			break;	

		case SYMBOL_SOUND_ON:
			loadControl(SYMBOL_SOUND, ON);
			break;

		case SYMBOL_SOUND_OFF:
